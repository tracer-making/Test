...
### 18. 文本播放界面 (TextPlayerState)

[TextPlayerState](../Tracer/src/states/TextPlayerState.h)是游戏的文本播放界面，用于在游戏流程中播放叙事文本。
...
#### 操作方式
- **键盘控制**：空格键下一句、A键自动播放、S键跳过、ESC键返回
- **鼠标控制**：点击文本区域下一句、点击按钮控制播放模式
