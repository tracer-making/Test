...
void CardDB::loadBuiltinCards() {
	...
	c = Card{"dishisanzi_juexing", u8"第十三子", 1, u8"鹿部", 2, 1, "face_dishisan", {u8"形态转换",u8"空袭",u8"生生不息"}, false}; registerCard(c);
	...
	c = Card{"shuchong_yizhuan", u8"书虫异篆", 1, u8"介部", 0, 3, "face_shuchong", {u8"一回合成长"}}; registerCard(c);
	c = Card{"shuchong_mojian", u8"书虫墨茧", 0, u8"介部", 0, 3, "face_shuchong", {u8"一回合成长"}, false}; registerCard(c);
	c = Card{"yuren_moke", u8"羽人墨客", 0, u8"介部", 7, 3, "face_shuchong", {u8"空袭"}, false}; registerCard(c);
	c = Card{"yunqian_fengchao", u8"芸签蜂巢", 1, u8"介部", 0, 2, "face_yunqian", {u8"内心之蜂"}}; registerCard(c);
	c = Card{"yunchuang_fengshi", u8"芸窗蜂使", 0, u8"介部", 1, 1, "face_yunchuang", {u8"空袭"}, false}; registerCard(c);
	...
	c = Card{"tail_segment", u8"断尾", 0, u8"鳞部", 0, 2, "face_tail", {}, false}; registerCard(c);
	
	// 其他
	// 破碎的卵（用于滋生寄生虫默认产物）
	c = Card{"posui_deluan", u8"破碎的卵", 0, u8"其他", 0, 1, "face_posui", {}, false}; registerCard(c);
	c = Card{"maoxiu_wo", u8"卯宿窝", 1, u8"其他", 0, 2, "face_maoxiu", {u8"兔窝", u8"继承印记"}}; registerCard(c);
	c = Card{"baimao_zi", u8"白毫仔", 0, u8"其他", 0, 1, "face_baimao", {}, false}; registerCard(c);
	c = Card{"shuigong_tuoshi", u8"水工柁师", 2, u8"其他", 1, 3, "face_shuigong", {u8"筑坝师", u8"堤坝附带印记"}}; registerCard(c);
	c = Card{"diba", u8"堤坝", 0, u8"其他", 0, 2, "face_diba", {}, false}; registerCard(c);
	...
	c = Card{"baina_ou", u8"百衲偶", 2, u8"其他", 3, 3, "face_baina", {u8"全物种", u8"蚂蚁类"}}; registerCard(c);
	...
	c = Card{"moding", u8"墨锭", 0, u8"其他", 0, 1, "face_moding", {}, false}; registerCard(c);
	...
	c = Card{"dulou_yan", u8"髑髅烟", 0, u8"其他", 0, 1, "face_dulou_yan", {u8"骨王"}, false}; registerCard(c);
	...
	c = Card{"langpi", u8"狼皮", 0, u8"其他", 0, 2, "face_langpi", {}, false}; registerCard(c);
	c = Card{"jinang_mao", u8"金羊皮", 0, u8"其他", 0, 3, "face_jinang", {}, false}; registerCard(c);
	c = Card{"tuopi_mao", u8"兔皮", 0, u8"其他", 0, 1, "face_tuopi", {}, false}; registerCard(c);

	// 磐石之身测试卡牌
	c = Card{"panshi", u8"磐石", 0, u8"其他", 0, 5, "face_panshi", {u8"磐石之身"}, false}; registerCard(c);

	// 铁兽夹测试卡牌
	c = Card{"tieshou_jia", u8"铁兽夹", 0, u8"其他", 0, 1, "face_tieshou", {u8"铁兽夹"}, false}; registerCard(c);
}
