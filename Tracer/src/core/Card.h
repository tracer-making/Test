...
struct Card {
	...
	bool obtainable = true;   // 是否可被获取（从游戏中加入到牌库）
	...
	// 带参数的构造函数
	Card(const std::string& id, const std::string& name, int sacrificeCost, const std::string& category, int attack, int health, const std::string& face, const std::vector<std::string>& marks = {}, bool obtainable = true)
